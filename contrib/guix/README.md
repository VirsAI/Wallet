# Bootstrappable VirsAI Core Builds

This directory contains the files necessary to perform bootstrappable VirsAI
Core builds.
...
To build VirsAI Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      VirsAI Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/virsai-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/virsaipay/guix.sigs).
...
[guix-docker]: https://github.com/VirsAI/tree/master/contrib/guix/Dockerfile
