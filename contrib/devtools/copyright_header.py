...
Arguments:
    <base_directory> - The base directory of a VirsAI Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The VirsAI Core developers'
...
Arguments:
    <base_directory> - The base directory of VirsAI Core source code repository.
"""
...
Arguments:
    <file> - A source file in the VirsAI Core repository.
"""
