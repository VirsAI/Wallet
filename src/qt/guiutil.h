...
/** Utility functions used by the VirsAI Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "virsai:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load virsai specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a virsai specific theme is activated (light/dark).*/
