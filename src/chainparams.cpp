 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1709920226, nBits=1e0ffff0, nNonce=459458, vtx=1)
...
{
    const char* pszTimestamp = "2024 virsai";
    const CScript genesisOutputScript = CScript() << ParseHex("04237ee493e244e58c967941c101c49f2ee0142a86bffd16c18f07759f41ecb0c74ab13aa0b84e5f82eb5ea1755e2d733c3d3d7e0b230881fb4dee04a35ec91906") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000a62e66d28cb49afe5501206f1b4eabb5d94359d72fc17032e1173d54f73"); 
        ...
        genesis = CreateGenesisBlock(1709920226, 459458, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000a62e66d28cb49afe5501206f1b4eabb5d94359d72fc17032e1173d54f73"));
        assert(genesis.hashMerkleRoot == uint256S("0x34a7a8ebc7451a1e8ac76d8d781bc99c5aea66b55c3dea5e63a1b97f68b82731"));
        ...
        // VirsAI BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // VirsAI BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // VirsAI BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"1CibFgbHprHQTi1KhCEcrVVUkqG9daFrLr"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000a62e66d28cb49afe5501206f1b4eabb5d94359d72fc17032e1173d54f73")},
            }
        };
        ...
        // getchaintxstats 17280 00000a62e66d28cb49afe5501206f1b4eabb5d94359d72fc17032e1173d54f73
        chainTxData = ChainTxData{
                1709920226, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000000237b199efbbf62aa29ec6972205585932b5d9995dbcb3fc37798de9d6c"); 
        ...
        genesis = CreateGenesisBlock(1709920231UL, 52171UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000000237b199efbbf62aa29ec6972205585932b5d9995dbcb3fc37798de9d6c"));
        assert(genesis.hashMerkleRoot == uint256S("0x34a7a8ebc7451a1e8ac76d8d781bc99c5aea66b55c3dea5e63a1b97f68b82731"));
        ...
        // Testnet VirsAI BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet VirsAI BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet VirsAI BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"VF26C1ycqybyCZ3dnH89jG9ivPrfJDtphn"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x000000237b199efbbf62aa29ec6972205585932b5d9995dbcb3fc37798de9d6c")},
            }
        };
        ...
        // getchaintxstats 17280 000000237b199efbbf62aa29ec6972205585932b5d9995dbcb3fc37798de9d6c
        chainTxData = ChainTxData{
                1709920231, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1709920236, 2, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x42895c34103b24d718edb0c0a70d9012a5fbd0f9c02d742d693ea6928bd36efa"));
        assert(genesis.hashMerkleRoot == uint256S("0x34a7a8ebc7451a1e8ac76d8d781bc99c5aea66b55c3dea5e63a1b97f68b82731"));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x42895c34103b24d718edb0c0a70d9012a5fbd0f9c02d742d693ea6928bd36efa")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 7evNaVY4uBfeXFApLfC8P411PkSJV97dXM8Y6hsdfMu8WS17YZU
        vSporkAddresses = {"VEeEFtGEMciWLxuU5fyYByWryLpfgztBKf"};
        nMinSporkKeys = 1;
        ...
        // Regtest VirsAI addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,70);
        // Regtest VirsAI script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,71);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,198);
        // Regtest VirsAI BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest VirsAI BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest VirsAI BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
