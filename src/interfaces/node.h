...
//! Interface for the src/evo part of a virsai node (virsaid process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a virsai node (virsaid process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a virsai node (virsaid process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a virsai node (virsaid process).
...
//! Top-level interface for a virsai node (virsaid process).
class Node
{
public:
    virtual ~Node() {}
