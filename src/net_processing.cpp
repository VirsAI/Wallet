 ...
 *  We have 4 times smaller block times in VirsAI, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        VirsAI Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // VIRS this code also handles non-TXs (VirsAI specific messages)
