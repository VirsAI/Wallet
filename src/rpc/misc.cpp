...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"virsai\" activates all VirsAI-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "virsai")
    + HelpExampleRpc("debug", "virsai+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The virsai address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The virsai address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of VirsAICOIN"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of VirsAICOIN of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in VirsAICOIN"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in VirsAICOIN"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in VirsAICOIN"},
                    {RPCResult::Type::NUM, "received", "The total number of VirsAICOIN received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "virsai-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* VirsAI features */
    { "virsai",               "mnsync",                 &mnsync,                 {} },
    { "virsai",               "spork",                  &spork,                  {"command"} },
    { "virsai",               "sporkupdate",            &sporkupdate,            {"name","value"} },
