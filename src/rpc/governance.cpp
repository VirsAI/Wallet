...
static UniValue gobject_prepare(const JSONRPCRequest& request)
{
    ...
    // This command is dangerous because it consumes 5 VIRS irreversibly.
    // If params are lost, it's very hard to bruteforce them and yet
    // users ignore all instructions on virsaicentral etc. and do not save them...
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    /* VirsAI features */
    { "virsai",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "virsai",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "virsai",               "gobject",                &gobject,                {} },
    { "virsai",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },
