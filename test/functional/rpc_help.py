...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: VirsAI's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'VirsAI', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
