...
"""Verify that starting virsaid with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start virsaid with -h for help text")
        ...
        self.log.info("Start virsaid with -version for version information")
        ...
        self.log.info("Start virsaidd with -fakearg to make sure it does not start")
