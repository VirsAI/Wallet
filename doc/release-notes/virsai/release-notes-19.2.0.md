...
At the first startup VirsAI Core will run a migration process which can take
...
incompatible with older versions of VirsAI Core, so a db migration path was
...
See detailed [set of changes](https://github.com/VirsAI/compare/v19.1.0...virsaipay:v19.2.0).
