...
- [`4bfc6ab30`](https://github.com/VirsAI/commit/4bfc6ab30) Merge #13788: Fix --disable-asm for newer assembly checks/code
...
- [`bf7485213`](https://github.com/VirsAI/commit/bf7485213) More "connman." to "connman->" changes
...
- [`7b80cc804`](https://github.com/VirsAI/commit/7b80cc804) Allow ignoring of known messages in mininode.py
...
- [`d09f88d98`](https://github.com/VirsAI/commit/d09f88d98) Merge #11077: [tests] fix timeout issues from TestNode
...
- [`dbd499308`](https://github.com/VirsAI/commit/dbd499308) Merge #10758: Fix some chainstate-init-order bugs.
...
- [`122da986c`](https://github.com/VirsAI/commit/122da986c) Merge #10415: [tests] Speed up fuzzing by ~200x when using afl-fuzz
...
- [`cfc697527`](https://github.com/VirsAI/commit/cfc697527) Merge #10985: Add undocumented -forcecompactdb to force LevelDB compactions
...
- [`b2b0bc9b0`](https://github.com/VirsAI/commit/b2b0bc9b0) Merge #10870: [Qt] Use wallet 0 in rpc console if running with multiple wallets
...
- [`72fbee959`](https://github.com/VirsAI/commit/72fbee959) Merge #11196: Switch memory_cleanse implementation to BoringSSL's to ensure memory clearing even with -lto
...
- [`9bcadebf7`](https://github.com/VirsAI/commit/9bcadebf7) Merge #10631: Use the override specifier (C++11) where we expect to be overriding the virtual function of a base class
...
- [`6b6ea2461`](https://github.com/VirsAI/commit/6b6ea2461) Merge #10642: Remove obsolete `_MSC_VER` check
...
- [`1099c1ad6`](https://github.com/VirsAI/commit/1099c1ad6) Merge #10546: Remove 33 unused Boost includes
...
- [`35bafa14b`](https://github.com/VirsAI/commit/35bafa14b) Merge #10515: [test] Add test for getchaintxstats
...
- [`ea3afb995`](https://github.com/VirsAI/commit/ea3afb995) Merge #10433: [tests] improve tmpdir structure
...
- [`3b3132539`](https://github.com/VirsAI/commit/3b3132539) update python tests
...
- [`a651f0d0f`](https://github.com/VirsAI/commit/a651f0d0f) adjust test_runner.py check if virsaid is running
...
- [`d9a4dea61`](https://github.com/VirsAI/commit/d9a4dea61) Remove CValidationInterface::UpdatedTransaction
...
- [`60438257a`](https://github.com/VirsAI/commit/60438257a) Merge #9725: CValidationInterface Cleanups
...
- [`ae05068c5`](https://github.com/VirsAI/commit/ae05068c5) Merge #10053: [test] Allow functional test cases to be skipped
...
- [`2aa3f890d`](https://github.com/VirsAI/commit/2aa3f890d) Merge #10029: Fix parameter naming inconsistencies between .h and .cpp files
- [`7edb9e15a`](https://github.com/VirsAI/commit/7edb9e15a) Merge #10017: combine_logs.py - aggregates log files from multiple bitcoinds during functional tests.
- [`f2e976a05`](https://github.com/VirsAI/commit/f2e976a05) Merge #10045: [trivial] Fix typos in comments
- [`2c833eff3`](https://github.com/VirsAI/commit/2c833eff3) Merge #10039: Fix compile errors with Qt 5.3.2 and Boost 1.55.0
- [`a6eee07f2`](https://github.com/VirsAI/commit/a6eee07f2) Merge bitcoin#9963: util: Properly handle errors during log message formatting (#2917)
- [`67c735b15`](https://github.com/VirsAI/commit/67c735b15) s/bitcoin-config.h/virsai-config.h/
- [`2f63322cd`](https://github.com/VirsAI/commit/2f63322cd) virsaiify "Finding reviewers" section to be more relevant
- [`e7a21faa2`](https://github.com/VirsAI/commit/e7a21faa2) Merge Bitcoin#9960: Trivial: Add const modifier to GetHDChain and IsHDEnabled
- [`eecc72436`](https://github.com/VirsAI/commit/eecc72436) Merge #10564: Return early in IsBanned.
- [`742744f25`](https://github.com/VirsAI/commit/742744f25) Merge #10522: [wallet] Remove unused variables
- [`31bb4622a`](https://github.com/VirsAI/commit/31bb4622a) Merge #10538: [trivial] Fix typo: "occurrences" (misspelled as "occurrances")
- [`f57063155`](https://github.com/VirsAI/commit/f57063155) Merge #10514: Bugfix: missing == 0 after randrange
- [`b708ea819`](https://github.com/VirsAI/commit/b708ea819) Merge #10469: Fixing typo in rpcdump.cpp
- [`55dc3dae5`](https://github.com/VirsAI/commit/55dc3dae5) Merge #10486: devtools: Retry after signing fails in github-merge
- [`0d2f2b361`](https://github.com/VirsAI/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/VirsAI/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/VirsAI/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/VirsAI/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/VirsAI/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/VirsAI/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/VirsAI/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/VirsAI/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/VirsAI/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/VirsAI/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/VirsAI/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/VirsAI/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/VirsAI/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/VirsAI/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/VirsAI/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/VirsAI/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/VirsAI/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/VirsAI/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/VirsAI/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/VirsAI/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/VirsAI/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/VirsAI/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/VirsAI/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/VirsAI/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/VirsAI/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/VirsAI/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/VirsAI/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/VirsAI/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/VirsAI/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/VirsAI/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/VirsAI/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/VirsAI/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/VirsAI/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/VirsAI/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/VirsAI/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/VirsAI/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/VirsAI/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/VirsAI/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/VirsAI/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/VirsAI/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/VirsAI/commit/1cfda206a) Merge #9993: Initialize nRelockTime
