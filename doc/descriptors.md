# Support for Output Descriptors in VirsAI Core

Since VirsAI Core v0.17, there is support for Output Descriptors. This is a
...
existing VirsAI Core wallets, a convenience function `combo` is
...
All RPCs in VirsAI Core will include the checksum in their output. Only
