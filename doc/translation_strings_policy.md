...
This document provides guidelines for internationalization of the VirsAI Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `virsai_en.ts` remains unchanged.
