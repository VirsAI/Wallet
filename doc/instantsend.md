...
This mechanism has been integrated into Bitcore-Node-VirsAI which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/virsaipay/insight-api-virsai#web-socket-api](https://github.com/virsaipay/insight-api-virsai#web-socket-api)
* API: [https://github.com/virsaipay/insight-api-virsai#instantsend-transactions](https://github.com/virsaipay/insight-api-virsai#instantsend-transactions)
